...
class ParkingSpot(BaseModel):
    ...
    length: Optional[confloat(ge=0.0)] = Field(
        None, description='Length of the parking spot'
    )
    location: Optional[
    ...
    ] = Field(None, description='Parking site to which the parking spot belongs to')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be ParkingSpot'
    )
    width: Optional[confloat(ge=0.0)] = Field(
        None, description='Width of the parking spot'
    )
