...
class ParkingAccess(BaseModel):
    ...
    height: Optional[float] = Field(None, description='Height of the access point')
    id: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
    ...
    refOffStreetParking: Optional[
        ...
        None, description='The offstreet parking site this access point gives access to'
    )
    seeAlso: Optional[Union[List[AnyUrl], AnyUrl]] = Field(
        None, description='list of uri pointing to additional resources about the item'
    )
    slope: Optional[float] = Field(
        None, description='Slope of the access point (in relative terms)'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be ParkingAccess'
    )
    width: Optional[float] = Field(None, description='Width of the access point')
